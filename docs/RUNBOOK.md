...
| Kimi 30–140s or timeout (exit 3) | k2.6 reasoning cannot be disabled — latency is inherently spiky | Expected. Keep Kimi on creative/lateral only; deepseek for anything latency-sensitive. |
